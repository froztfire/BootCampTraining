...
public class EmployeeController {
    ...
    //+++++++++++++++++++++++++++++++++++++++++-DELETE EMPLOYEE-++++++++++++++++++++++++++++++++++++++++++++++
    @DeleteMapping("/{id}")
    ResponseEntity <String> deleteEmployee(@PathVariable Long id) throws RecordNotFoundException {
        return new ResponseEntity<>( empService.deleteEmployee(id), HttpStatus.ACCEPTED);
    }
    ...
    //++++++++++++++++++++++++++++++++++++++-SEARCH EMPLOYEE BY NAME LIKE-+++++++++++++++++++++++++++++++++++++++++++++
    @GetMapping("/search")
    public Page<Employee> fetchCustomersAsFilteredList(@RequestParam(defaultValue = "") String nameFilter,
                                                       @RequestParam(defaultValue = "0") int page,
                                                       @RequestParam(defaultValue = "30") int size) {
        return empService.fetchFilteredEmployeeDataAsList(nameFilter, page , size);
    }
}
